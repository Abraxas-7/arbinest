...
@section('title', 'Crea Nuovo Evento')
        ...
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-header">
                    <h1 class="h3 mb-0">Crea Nuovo Evento</h1>
                    <p class="text-muted mb-0">Compila i dettagli del tuo evento</p>
                </div>
                <div class="card-body">
                    <form action="{{ route('events.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="description" name="description" rows="4"
                                class="form-control @error('description') is-invalid @enderror" placeholder="Descrivi il tuo evento...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
